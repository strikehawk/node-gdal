	...
	"targets": [
		{
			...
			"sources": [
				...
				"src/apps/gdal_translate.cpp",
				"src/vrt/gdal_vrtdataset.cpp",
				"src/vrt/gdal_vrtsources.cpp",
				"src/vrt/vrtdataset_bands.cpp",
				"src/vrt/gdal_vrtsourcedrasterband.cpp",
